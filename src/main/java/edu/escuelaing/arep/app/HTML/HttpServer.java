package edu.escuelaing.arep.app.HTML;
        ...
        while (true) {
            ...
            if(!res.equals("")){
                if (res.substring(0, 3).equals("GET")) {
                    ...
                    File archivoEncontrado = find.buscador(res.substring(8, res.length() - 9), new File("C:\\Users\\Felipe\\Desktop\\Trabajos Universidad\\10mo Semestre\\AREP\\AREP-TallerSparkWebHeroku\\src\\main"));
                    ...
                    if (archivoEncontrado != null) {
                        ...
                        if(res.substring(5, 7).equals("im")){
                            BufferedImage image = ImageIO.read(new File("C:\\Users\\Felipe\\Desktop\\Trabajos Universidad\\10mo Semestre\\AREP\\AREP-TallerSparkWebHeroku\\src\\main\\java\\resource\\img\\Battler.PNG"));
